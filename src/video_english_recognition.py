...
try:
    ...
    try:
        ...
        print("Error: MoviePy is not properly installed. Please install it with: pip install moviepy")
        sys.exit(1)
        ...
        try:
            ...
            with open(output_path, 'w', encoding='utf-8') as f:
                ...
                for segment in result['segments']:
                    ...
                    f.write(f"[{int(start_min):02d}:{start_sec:05.2f} - {int(end_min):02d}:{end_sec:05.2f}] {text}\n")
